 ...
 */
 ...
 #define CSON_MODEL_CHAR(type, key) \
         {CSON_TYPE_CHAR, "", offsetof(type, key)}
 ...
 #define CSON_MODEL_SHORT(type, key) \
         {CSON_TYPE_SHORT, "", offsetof(type, key)}
 ...
 #define CSON_MODEL_INT(type, key) \
         {CSON_TYPE_INT, "", offsetof(type, key)}
 ...
 #define CSON_MODEL_LONG(type, key) \
         {CSON_TYPE_LONG, "", offsetof(type, key)}
 
                 /**
  * @brief unsigned char型数据模型
  * 
  * @param type 对象模型
  * @param key 数据键值
  */
 #define CSON_MODEL_UCHAR(type, key) \
         {CSON_TYPE_UCHAR, "", offsetof(type, key)}
 
 /**
  * @brief unsigned short型数据模型
  * 
  * @param type 对象模型
  * @param key 数据键值
  */
 #define CSON_MODEL_USHORT(type, key) \
         {CSON_TYPE_USHORT, "", offsetof(type, key)}
 
 /**
  * @brief unsigned int型数据模型
  * 
  * @param type 对象模型
  * @param key 数据键值
  */
 #define CSON_MODEL_UINT(type, key) \
         {CSON_TYPE_UINT, "", offsetof(type, key)}
 
 /**
  * @brief unsigned long型数据模型
  * 
  * @param type 对象模型
  * @param key 数据键值
  */
 #define CSON_MODEL_ULONG(type, key) \
         {CSON_TYPE_ULONG, "", offsetof(type, key)}
 /**
  * @brief float型数据模型
  * 
  * @param type 对象模型
 ...
 #define CSON_MODEL_FLOAT(type, key) \
         {CSON_TYPE_FLOAT, "", offsetof(type, key)}
 ...
 #define CSON_MODEL_DOUBLE(type, key) \
         {CSON_TYPE_DOUBLE, "", offsetof(type, key)}
 ...
 #define CSON_MODEL_STRING(type, key) \
         {CSON_TYPE_STRING, "", offsetof(type, key)}
 ...
 #define CSON_MODEL_STRUCT(type, key, submodel, subsize) \
         {CSON_TYPE_STRUCT, "", offsetof(type, key), .param.sub.model=submodel, .param.sub.size=subsize}
 ...
 #define CSON_MODEL_LIST(type, key, submodel, subsize) \
         {CSON_TYPE_LIST, "", offsetof(type, key), .param.sub.model=submodel, .param.sub.size=subsize}
 ...
 #define CSON_MODEL_ARRAY(type, key, elementType, arraySize) \
         {CSON_TYPE_ARRAY, "", offsetof(type, key), .param.array.eleType=elementType, .param.array.size=arraySize}
 ...
 #define CSON_MODEL_JSON(type, key) \
         {CSON_TYPE_JSON, "", offsetof(type, key)}
